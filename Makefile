...
CPPFLAGS = -O2 -Wall -Werror -DKKURZ_MPI -fopenmp
CC = mpicxx
...
SRCS := Alphabet.cpp Cluster.cpp Counter.cpp Data_structure.cpp DNAAlphabet.cpp Ds_iterator.cpp GFF_generator.cpp Motif.cpp Motif_logo.cpp Motif_scoring.cpp OWEF_args.cpp OWEF.cpp Radix_trie.cpp Radix_trie_leaf.cpp Radix_trie_node.cpp Rmes_model.cpp RMESString.cpp Rt_iterator.cpp Scores.cpp Word.cpp Word_family.cpp Word_scoring.cpp 
